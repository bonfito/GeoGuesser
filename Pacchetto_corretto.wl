...
MostraClassificaGUI[score_Integer] := DynamicModule[
{
  ...
  (*file = FileNameJoin[{NotebookDirectory[], "score.json"}]*)
  file = With[{dir = Quiet[NotebookDirectory[]]},
  If[StringQ[dir], FileNameJoin[{dir, "score.json"}], 
     FileNameJoin[{$UserDocumentsDirectory, "score.json"}]
  ]
]
